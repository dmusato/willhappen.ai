...
import { getIndex, getPrediction, putPrediction, readIndex, writeIndexDoc } from "../store/kv.js";
...
export async function loadPrediction(env, request, id) {
  ...
  const live = await getPrediction(env, id);
  if (live) return live;
